    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'مدير المؤسسه'), (2, 'مشرف جمعيه رئيسيه'), (3, 'مشرف جمعيه تنمويه'), (4, 'مشرف متعاون'), (5, 'محتاج'), (6, 'متبرع')], help_text='User Role in A system ', null=True, verbose_name='User Type')),
